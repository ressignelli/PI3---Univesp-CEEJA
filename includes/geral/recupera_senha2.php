...
$cpf = $_POST['cpf'];
    ...
    $consulta_emp = mysqli_query($conn, "SELECT * FROM tab_empregador WHERE cpf_cnpj = '$cpf' and email = '$email'");
    $array_resul = mysqli_fetch_array($consulta_emp);
    ...
    if($array_resul==NULL){
        ...
        $sql = "UPDATE tab_empregador SET senha='$senha' WHERE cpf_cnpj='$cpf'";
